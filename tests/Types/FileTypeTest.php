...
class FileTypeTest extends TestTypeAbstract
{
	...
	{
		$this->assertInternalType('null', $this->mock->v, 'DTYPE_FILE must have null unconverted');
	}

	/**
	 * Test uploading from data uri
	 */
	public function testUploadingFromDataUri()
	{
